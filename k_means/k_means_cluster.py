...
### find the maximum and minimum data of exercised_stock_options
exercised_stock_options = featureFormat(data_dict,["exercised_stock_options"])
...
for f1, f2 in finance_features:   # f3
